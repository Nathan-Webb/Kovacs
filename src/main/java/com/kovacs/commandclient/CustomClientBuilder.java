...
//Made an edit to use my own Custom CommandClientImpl to override some methods
public class CustomClientBuilder
{
    ...
    {
        CommandClient client = new CustomClientImpl(ownerId, coOwnerIds, prefix, altprefix, activity, status, serverInvite,
                success, warning, error, carbonKey, botsKey, new ArrayList<>(commands), useHelp,
                shutdownAutomatically, helpConsumer, helpWord, executor, linkedCacheSize, compiler, manager); //hacky, but whatever
        if(listener!=null)
     ...
     * @return This builder
     */
    public CustomClientBuilder setOwnerId(String ownerId)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setCoOwnerIds(String... coOwnerIds)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setPrefix(String prefix)
    {
        this.prefix = prefix;
        return this;
    }
     ...
     * @return This builder
     */
    public CustomClientBuilder setAlternativePrefix(String prefix)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder useHelpBuilder(boolean useHelp)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setHelpConsumer(Consumer<CommandEvent> helpConsumer)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setHelpWord(String helpWord)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setServerInvite(String serverInvite)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setEmojis(String success, String warning, String error)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setActivity(Activity activity)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder useDefaultGame()
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setStatus(OnlineStatus status)
    {
        this.status = status;
        return this;
    }
     ...
     * @return This builder
     */
    public CustomClientBuilder addCommand(Command command)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder addCommands(Command... commands)
    {
     ...
     */
    public CustomClientBuilder addAnnotatedModule(Object module)
    {
     ...
     * @see    com.jagrosh.jdautilities.command.annotation.JDACommand
     */
    public CustomClientBuilder addAnnotatedModules(Object... modules)
    {
     ...
     * @see    com.jagrosh.jdautilities.command.annotation.JDACommand
     */
    public CustomClientBuilder setAnnotatedCompiler(AnnotatedModuleCompiler compiler)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setCarbonitexKey(String key)
    {
        this.carbonKey = key;
        return this;
    }
     ...
     * @return This builder
     */
    public CustomClientBuilder setDiscordBotsKey(String key)
    {
        this.botsKey = key;
        return this;
    }
     ...
     */
    @Deprecated
    public CustomClientBuilder setDiscordBotListKey(String key)
    {
        // this.botsOrgKey = key;
        return this;
    }
     ...
     * @return This builder
     */
    public CustomClientBuilder setListener(CommandListener listener)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setScheduleExecutor(ScheduledExecutorService executor)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setShutdownAutomatically(boolean shutdownAutomatically)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setLinkedCacheSize(int linkedCacheSize)
    {
     ...
     * @return This builder
     */
    public CustomClientBuilder setGuildSettingsManager(GuildSettingsManager manager)
    {
